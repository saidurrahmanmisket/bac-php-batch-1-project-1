							...
							<div class="row">
								<div class="col-xl-8 col-lg-7 col-md-12">
									<div class="card overflow-hidden">
										<a href="blog-details.html" class="card custom-card background-image-blog img1 mb-0">
											...
											<div class="row">
												<div class="col-xl-6 col-md-12 my-2 p-xl-max-0">
													<div class="card overflow-hidden box-shadow mb-0 main-blog">
														<a href="blog-details.html" class="background-image-blog img2 mb-0">
									...
									<div class="card">
										...
										<div class="card-body">
											<div class="row">
												...
												<div class="col-xl-6 col-md-12">
													<div class="card overflow-hidden box-shadow mb-0 main-blog">
														<a href="blog-details.html" class="background-image-blog img4 mb-0">
