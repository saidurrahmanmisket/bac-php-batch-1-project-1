                            ...
                            <div class="card-body">
                                <div class="">
                                    <form class="form-horizontal" method="POST"
                                        action="{{ route('dashboard.blog.category.update', ['id' => $category->id]) }}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="defaultconfig" class="form-label">Name:</label>
                                            <input name="name" type="text" class="form-control" maxlength="25"
                                                id="defaultconfig" value="{{ $category->name }}">
                                            @error('name')
                                        ...
                                        <div class="" style="width: 100px">
                                            <img class="img-fluid" src="{{ asset($category->image ) }}" alt="" srcset="">
                                        </div>
