...
<div class="banner_section slide_medium shop_banner_slider staggered-animation-wrap">
    <div id="carouselExampleControls" class="carousel slide carousel-fade light_arrow" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item background_bg active" data-img-src="{{ asset('frontend/assets/images/banner16.jpg') }}">
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                ...
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            ...
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img2.jpg') }}" alt="el_hover_img2">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                ...
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            ...
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img3.jpg') }}" alt="el_hover_img3">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img4.jpg') }}" alt="el_img4">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img4.jpg') }}" alt="el_hover_img4">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img5.jpg') }}" alt="el_img5">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img5.jpg') }}" alt="el_hover_img5">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img6.jpg') }}" alt="el_img6">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img6.jpg') }}" alt="el_hover_img6">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                        ...
                        <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img7.jpg') }}" alt="el_img7">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img7.jpg') }}" alt="el_hover_img7">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img8.jpg') }}" alt="el_img8">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img8.jpg') }}" alt="el_hover_img8">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img9.jpg') }}" alt="el_img9">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img9.jpg') }}" alt="el_hover_img9">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    ...
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img10.jpg') }}" alt="el_img10">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img10.jpg') }}" alt="el_hover_img10">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img11.jpg') }}" alt="el_img11">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img11.jpg') }}" alt="el_hover_img11">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                            ...
                            <div class="item">
                                <div class="product_wrap">
                                    <div class="product_img">
                                        <a href="shop-product-detail.html">
                                            <img src="{{ asset('frontend/assets/images/el_img12.jpg') }}" alt="el_img12">
                                            <img class="product_hover_img" src="{{ asset('frontend/assets/images/el_hover_img12.jpg') }}" alt="el_hover_img12">
                                        </a>
                                        <div class="product_action_box">
                                            <ul class="list_none pr_action_btn">
                                                <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
	...
	<div class="container">
    	<div class="row">
        	<div class="col-12">
            	<div class="sale-banner mb-3 mb-md-4">
                	<a class="hover_effect1" href="#">
                		<img src="{{ asset('frontend/assets/images/shop_banner_img11.png') }}" alt="shop_banner_img11">
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-9">
            	<div class="testimonial_wrap testimonial_style1 carousel_slider owl-carousel owl-theme nav_style2" data-nav="true" data-dots="false" data-center="true" data-loop="true" data-autoplay="true" data-items='1'>
                	<div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{ asset('frontend/assets/images/user_img1.jpg') }}" alt="user_img1" />
                            </div>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{ asset('frontend/assets/images/user_img2.jpg') }}" alt="user_img2" />
                            </div>
                            <div class="author_name">
                                <h6>Alden Smith</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{ asset('frontend/assets/images/user_img3.jpg') }}" alt="user_img3" />
                            </div>
                            <div class="author_name">
                                <h6>Daisy Lana</h6>
                                <span>Designer</span>
                    ...
                    <div class="testimonial_box">
                        ...
                        <div class="author_wrap">
                            <div class="author_img">
                                <img src="{{ asset('frontend/assets/images/user_img4.jpg') }}" alt="user_img4" />
                            </div>
                            <div class="author_name">
                                <h6>John Becker</h6>
                                <span>Designer</span>
        ...
        <div class="row">
        	<div class="col-12">
            	<div class="client_logo carousel_slider owl-carousel owl-theme" data-dots="false" data-margin="30" data-loop="true" data-autoplay="true" data-responsive='{"0":{"items": "2"}, "480":{"items": "3"}, "767":{"items": "4"}, "991":{"items": "5"}}'>
                    ...
                    <div class="item">
                        <div class="cl_logo">
                        	<img src="{{ asset('frontend/assets/images/cl_logo7.png') }}" alt="cl_logo"/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                	<div class="widget">
                        ...
                        <ul class="app_list">
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/f1.png') }}" alt="f1"/></a></li>
                            <li><a href="#"><img src="{{ asset('frontend/assets/images/f2.png') }}" alt="f2"/></a></li>
                        </ul>
                    </div>
                	<div class="widget">
